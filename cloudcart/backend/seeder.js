...
const mockProducts = [
  ...
  { name: 'Serverless API Gateway', description: 'Fully managed HTTP API gateway with integrated security controls, JWT authorization, and automatic scaling.', price: 79.99, category: 'Networking', image: 'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=400', rating: 4.6, reviews: 143, stock: 120, tags: ['serverless', 'gateway', 'security'] },
  { name: 'OCI Container Registry', description: 'Private secure Docker/OCI container registry with active vulnerability scanning, image signing, and georeplication.', price: 49.99, category: 'Containers', image: 'https://images.unsplash.com/photo-1667372393119-3d4c48d07fc9?w=400', rating: 4.7, reviews: 88, stock: 250, tags: ['registry', 'docker', 'images'] },
  { name: 'Log Aggregator Pro', description: 'Elasticsearch-compatible real-time log ingestion, search, and dashboard visualization suite.', price: 129.99, category: 'Monitoring', image: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=400', rating: 4.8, reviews: 194, stock: 80, tags: ['logging', 'elasticsearch', 'observability'] }
];
